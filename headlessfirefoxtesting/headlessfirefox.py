...
def main():
    ...
    driver = webdriver.Firefox(firefox_options=ffox_options, executable_path="/Users/runyanjake/Desktop/Academia/CodingStuff/Repositories/cryptogoochers/headlessfirefoxtesting/firefoxdriver/geckodriver")
